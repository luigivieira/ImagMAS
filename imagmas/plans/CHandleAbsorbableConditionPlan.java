...
/**
 * Plano: Recebimento de Informação de Condição de Absorvível
 * Agente Utilizador: Marcador de Centro (MC)
 * Propósito: Receber e tratar a informação da condição de
 * absorvível por outro agente.
...
public class CHandleAbsorbableConditionPlan extends Plan
{
	...
	public void body()
	{
		...
		/*
		 * Obtem do conteúdo da mensagem a instância da ontologia com as
		 * informações comunicadas.
		 */
		CAbsorbableConditionInformation pAbs = (CAbsorbableConditionInformation) pMsg.getContent();
		
		/*
		 * Atualiza a crença sobre a condição de absorvível por outro
		 * agente de acordo com a informação recebida.
		 */
