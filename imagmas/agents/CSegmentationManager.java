...
public class CSegmentationManager extends CAbstractAgent
{
	public CSegmentationManager(AgentIdentifier pAgentIdentifier)
	{
		super(pAgentIdentifier);
		
		// +--- Adiciona os sensores utilizados pelo agente
		addSensor(new CRegionSensor("region"));
