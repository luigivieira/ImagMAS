...
/**
 * Classe de ação para atualizar a imagem representativa da segmentação da imagem original.
 *
...
public class CUpdateSegmentationCommand extends AbstractAction
{
	...
	public CUpdateSegmentationCommand(CMainWindow pWindow)
	{
		...
		putValue(Action.SHORT_DESCRIPTION, "Atualizar a exibição do estado da segmentação");
	 ...
	 * Atualiza a imagem representativa da segmentação da imagem original.
